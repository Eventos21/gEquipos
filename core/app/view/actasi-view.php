...
<div class="main-content">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="jornadasi" class="btn btn-gradient btn-lg d-flex align-items-center justify-content-center shadow-lg" style="border-radius: 50px; padding: 1px 5px; text-transform: uppercase; font-weight: bold; background: linear-gradient(45deg, #007bff, #00d4ff); color: white; transition: all 0.3s ease;">
 ...
 <form id="firmaForm" enctype="multipart/form-data" method="post">
    <div class="col-md-12 mb-3">
        ...
        <textarea readonly="" style="font-size: 9px;" class="form-control" name="observaciona"><?= $competiciones->observaciona; ?></textarea>
    </div>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <input type="hidden" name="actions" value="63">
                                                             <?php echo $data2->apellido1 . ' ' . $data2->apellido2 . ', ' . $data2->nombre; ?>
                                                        </form>
                                                    </td>
...
<form id="firmaForm1" enctype="multipart/form-data" method="post">
    <div class="col-md-12 mb-3">
        ...
        <textarea readonly="" style="font-size: 9px;" class="form-control" name="observacionb"><?= $competiciones->observacionb; ?></textarea>
    </div>
        <input style="font-size: 9px;" value="<?= $competiciones->firmab; ?>" type="hidden" name="firmab" class="form-control w-auto">
    <div class="col-md-12 mb-3">
        <label for="firma" class="form-label text-primary fw-bold me-2">Acta</label>
            <input style="font-size: 9px; margin-right: 10px;" type="hidden" name="archivo" class="form-control w-auto">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <input type="hidden" name="actions" value="63">
                                                            <?php echo $data4->apellido1 . ' ' . $data4->apellido2 . ', ' . $data4->nombre; ?>
                                                        </form>
                                                    </td>
                            ...
                            <div <?php if ($competiciones->firma_arbitro!="") { ?> id="modal-body2" <?php }  ?> class="modal-body bg-light p-3 rounded">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea readonly="" class="form-control" name="observacion_arbitro"><?= $competiciones->observacion_arbitro;?></textarea>
                                    </div>
                            ...
                            <div <?php if ($competiciones->aprobacion=="OK") { ?> id="modal-body3" <?php }  ?> class="modal-body bg-light p-3 rounded">
                                <div class="row mb-3" >
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea readonly="" class="form-control" name="obervacion_fma"><?php echo $competiciones->obervacion_fma; ?></textarea>
                                    </div>
                                    <div class="col-md-4 mb-3">
