...
$columnas = [
    'encuentro1_a' => ['estado1_a', 'accion1_a', 'observacion1_a', 'firma1_a', 'usuario1', 'arbitro1', 'observacion_arbitro1', 'firma_arbitro1', 'obervacion_fma1', 'aprobacion1'],
    'encuentro2_a' => ['estado2_a', 'accion2_a', 'observacion2_a', 'firma2_a', 'usuario2', 'arbitro2', 'observacion_arbitro2', 'firma_arbitro2', 'obervacion_fma2', 'aprobacion2'],
    'encuentro3_a' => ['estado3_a', 'accion3_a', 'observacion3_a', 'firma3_a', 'usuario3', 'arbitro3', 'observacion_arbitro3', 'firma_arbitro3', 'obervacion_fma3', 'aprobacion3'],
    'encuentro4_a' => ['estado4_a', 'accion4_a', 'observacion4_a', 'firma4_a', 'usuario4', 'arbitro4', 'observacion_arbitro4', 'firma_arbitro4', 'obervacion_fma4', 'aprobacion4'],
    'encuentro5_a' => ['estado5_a', 'accion5_a', 'observacion5_a', 'firma5_a', 'usuario5', 'arbitro5', 'observacion_arbitro5', 'firma_arbitro5', 'obervacion_fma5', 'aprobacion5'],
    'encuentro6_a' => ['estado6_a', 'accion6_a', 'observacion6_a', 'firma6_a', 'usuario6', 'arbitro6', 'observacion_arbitro6', 'firma_arbitro6', 'obervacion_fma6', 'aprobacion6'],
    'encuentro7_a' => ['estado7_a', 'accion7_a', 'observacion7_a', 'firma7_a', 'usuario7', 'arbitro7', 'observacion_arbitro7', 'firma_arbitro7', 'obervacion_fma7', 'aprobacion7'],
];
$consulta = "SELECT id, ";
...
// ****************************************************************************
$columnas1 = [
    'encuentro1_b' => ['estado1_b', 'accion1_b', 'observacion1_b', 'firma1_b'],
    'encuentro2_b' => ['estado2_b', 'accion2_b', 'observacion2_b', 'firma2_b'],
    'encuentro3_b' => ['estado3_b', 'accion3_b', 'observacion3_b', 'firma3_b'],
    'encuentro4_b' => ['estado4_b', 'accion4_b', 'observacion4_b', 'firma4_b'],
    'encuentro5_b' => ['estado5_b', 'accion5_b', 'observacion5_b', 'firma5_b'],
    'encuentro6_b' => ['estado6_b', 'accion6_b', 'observacion6_b', 'firma6_b'],
    'encuentro7_b' => ['estado7_b', 'accion7_b', 'observacion7_b', 'firma7_b'],
];
$consulta1 = "SELECT id, ";
...
$query = "SELECT $columna_observacion_a,$columna_firma_a, $columna_usuario, $columna_arbitro, $columna_observacion_arbitro, $columna_firma_arbitro, $columna_observacion_fma, $columna_aprobacion, $columna_observacion_b, $columna_firma_b FROM competencias WHERE id = $competiciones->id";
