...
if ($_SESSION["typeuser"]==2) {
    ...
    $clubcito = ClubData::verid1($u->club);
}
$competiciones = SalaPersonalizadaData::verid2($_POST['tid']);
$salas = SalaData::verid($competiciones->sala);
$compet = CompeticionData::verid($salas->competicion);
$aquipoa = EquipoData::verid($competiciones->id_competidor);
$aquipob = EquipoData::verid($competiciones->id_rival);
$identificador = 0;
$vala = 0;
$valb = 0;
if ($clubcito->id==$aquipoa->club) {
    $vala = 1;
}
if ($clubcito->id==$aquipob->club) {
    $valb = 1;
}
$identificador = $vala + $valb;
...
<div class="main-content">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($datas as $data) { ?>
                                                <tr>
                                                    ...
                                                    <?php } else { ?> 
                                                    <td>
                                                        <select <?php if ($identificador==0) {
                                                   echo " disabled "; } ?> class="resultado-select" data-id="<?php echo $data->id; ?>">
                                                    ...
                                                    <?php } ?>
                                                    <td><button <?php if ($identificador==0) {
                                                   echo " disabled "; } ?> class="delete-btn btn btn-danger me-2" data-id="<?php echo $data->id; ?>">Limpiar</button></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
 ...
 <form id="firmaForm" enctype="multipart/form-data" method="post">
    <div class="col-md-12 mb-3">
        ...
        <input style="font-size: 9px;" value="<?= $competiciones->firmaa; ?>" type="hidden" name="firmaa" class="form-control w-auto">
    <div class="col-md-12 mb-3">
    ...
    <div class="modal-footer bg-info d-flex justify-content-between pb-0 border-top mt-3">
        ...
        <button <?php if ($identificador==0) { echo " disabled "; } ?> type="button" class="btn btn-primary submit-firma-form">Enviar</button>
    </div>
</form>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <button <?php if ($identificador==0) { echo " disabled "; } ?> class="btn btn-light me-2 submit-player-form"><?php echo $data2->apellido1 . ' ' . $data2->apellido2 . ', ' . $data2->nombre; ?></button>
                                                        </form>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <input type="hidden" name="actions" value="63">
                                                            <button <?php if ($identificador==0) { echo " disabled "; } ?> type="button" class="btn btn-light me-2 submit-player-form">Incomparecencia</button>
                                                        </form>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($datas as $data) { ?>
                                                <tr>
                                                    ...
                                                    <?php } else { ?>
                                                    <td>
                                                        <select <?php if ($identificador==0) { echo " disabled "; } ?> class="resultado-select1" data-id="<?php echo $data->id; ?>">
                                                            <option value="">Elegir</option>
                                                            <option value="1" <?php if ($data->resultado == '1') echo 'selected'; ?>>1</option>
                                                            <option value="1/2" <?php if ($data->resultado == '1/2') echo 'selected'; ?>>1/2</option>
                                                            <option value="0" <?php if ($data->resultado == '0') echo 'selected'; ?>>0</option>
                                                    ...
                                                    <?php } ?>
                                                    <td><button <?php if ($identificador==0) { echo " disabled "; } ?> class="delete-btn1 btn btn-danger me-2" data-id="<?php echo $data->id; ?>">Limpiar</button></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
...
<form id="firmaForm1" enctype="multipart/form-data" method="post">
    <div class="col-md-12 mb-3">
        ...
        <input style="font-size: 9px;" value="<?= $competiciones->firmab; ?>" type="hidden" name="firmab" class="form-control w-auto">
    <div class="col-md-12 mb-3">
        <label for="firma" class="form-label text-primary fw-bold me-2">Acta</label>
        <div style="display: flex; align-items: center;">
            <input style="font-size: 9px; margin-right: 10px;" type="file" name="archivo" class="form-control w-auto">
    ...
    <div class="modal-footer bg-info d-flex justify-content-between pb-0 border-top mt-3">
        ...
        <button <?php if ($identificador==0) { echo " disabled "; } ?> type="button" class="btn btn-primary submit-firma-form1">Enviar</button>
    </div>
</form>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <input type="hidden" name="actions" value="63">
                                                            <button <?php if ($identificador==0) { echo " disabled "; } ?> type="button" class="btn btn-light me-2 submit-player-form1"><?php echo $data4->apellido1 . ' ' . $data4->apellido2 . ', ' . $data4->nombre; ?></button>
                                                        </form>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <input type="hidden" name="jugador" value="">
                                                            <input type="hidden" name="actions" value="63">
                                                            <button <?php if ($identificador==0) { echo " disabled "; } ?> type="button" class="btn btn-light me-2 submit-player-form1">Incomparecencia</button>
                                                        </form>
                                                    </td>
                                                    <td></td>
                                                </tr>
                            ...
                            <div <?php if ($competiciones->firma_arbitro!="") { ?> id="modal-body2" <?php }  ?> class="modal-body bg-light p-3 rounded">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select disabled="" name="arbitro" class="form-select">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="hidden" value="<?= $competiciones->firma_arbitro;?>" name="firma_arbitro" class="form-control w-auto">
                                    <div class="modal-footer bg-info d-flex justify-content-between pb-0 border-top mt-3">
                                        <input type="hidden" name="id" value="<?php echo $competiciones->id; ?>">
                                        <input type="hidden" name="actions" value="59">
                                        <button disabled="disabled" type="submit" class="btn btn-primary submit-firma-form2">Enviar Firma</button>
                                    </div>
                                    </form>
<script>
    $(document).ready(function() {
                            ...
                            <div <?php if ($competiciones->aprobacion=="OK") { ?> id="modal-body3" <?php }  ?> class="modal-body bg-light p-3 rounded">
                                <div class="row mb-3" >
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select disabled="" name="aprobacion" class="form-select">
                                ...
                                <div class="modal-footer bg-info d-flex justify-content-between pb-0 border-top mt-3">
                                    ...
                                    <button disabled="disabled" type="submit" class="btn btn-primary submit-firma-form3">Enviar Acta</button>
                                </div>
                            </div>
                            </form>
<script>
