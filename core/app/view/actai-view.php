                                ...
                                <div class="col-md-6">
                                    ...
                                    <form id="firmaForm" enctype="multipart/form-data" method="post">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea readonly="" style="font-size: 9px;" class="form-control" name="observacion"><?= $observaciona;?></textarea>
                                        </div>
                                            <input style="font-size: 9px;" value="<?= $firmaa;?>" type="hidden" name="firma" class="form-control w-auto">
                                        <div class="col-md-12 mb-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <button class="btn btn-light me-2"><?php echo $data2->apellido1 . ' ' . $data2->apellido2 . ', ' . $data2->nombre; ?></button>
                                                        </form>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <input type="hidden" name="actions" value="52">
                                                            <button  type="button" class="btn btn-light me-2">Incomparecencia</button>
                                                        </form>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                    ...
                                    <div style="font-size: 9px;" class="modal-body bg-light p-2 rounded">
                                        <div class="row mb-3">
                                            <form id="firmaForm1" enctype="multipart/form-data" method="post">
                                                <div class="col-md-12 mb-3">
                                                    <label for="observacion" class="form-label text-primary fw-bold">Observación del Equipo Local</label>
                                                    <textarea readonly="" style="font-size: 9px;" class="form-control" name="observacion"><?= $observacionb;?></textarea>
                                                </div>
                                                    <input style="font-size: 9px;" value="<?= $firmab;?>" type="hidden" name="firma" class="form-control w-auto">
                                                <div class="col-md-12 mb-3">
                                                    <label for="firma" class="form-label text-primary fw-bold me-2">Acta</label>
                                                        <?php if ($achivob!="") {
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($datas4 as $data4) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                            <button type="button" class="btn btn-light me-2"><?php echo $data4->apellido1 . ' ' . $data4->apellido2 . ', ' . $data4->nombre; ?></button>
                                                    </td>
                            ...
                            <div <?php if ($firma_ar!="") { ?> id="modal-body2" <?php }  ?> class="modal-body bg-light p-3 rounded">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea readonly="readonly" class="form-control" name="observacion_arbitro"><?= $observacion_arb;?></textarea>
                                    </div>
                            ...
                            <div <?php if ($aprobacion=="OK") { ?> id="modal-body3" <?php }  ?> class="modal-body bg-light p-3 rounded">
                                <div class="row mb-3" >
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea readonly="readonly" class="form-control" name="observacion_fma"><?php echo $observacion_fma; ?></textarea>
                                    </div>
                                    <div class="col-md-4 mb-3">
