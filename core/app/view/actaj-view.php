                                ...
                                <div class="col-md-6">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($datas as $data) { ?>
                                                <tr>
                                                   ...
                                                   echo " disabled ";
                                                } ?> class="resultado-select" data-id="<?php echo $data->id; ?>">
                                                            <option value=""></option>
                                                   ...
                                                   echo " disabled ";
                                                } ?> class="delete-btn btn btn-danger me-2" data-id="<?php echo $data->id; ?>">Limpiar</button></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
                                    ...
                                    <form id="firmaForm" enctype="multipart/form-data" method="post">
                                        ...
                                        <!-- <div class="d-flex align-items-center">
                                            ...
                                            <input style="font-size: 9px;" value="<?= $firmaa;?>" type="hidden" name="firma" readonly class="form-control w-auto">
                                        <!-- </div> -->
                                        <div class="col-md-12 mb-3">
                                        ...
                                        <div class="modal-footer bg-info d-flex justify-content-between pb-0 border-top mt-3">
                                            ...
                                            <button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> type="button" class="btn btn-primary submit-firma-form">Enviar</button>
                                        </div>
                                    </form>
<script>
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?>  class="btn btn-light me-2 submit-player-form"><?php echo $data2->apellido1 . ' ' . $data2->apellido2 . ', ' . $data2->nombre; ?></button>
                                                        </form>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> type="button" class="btn btn-light me-2 submit-player-form">Incomparecencia</button>
                                                        </form>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            <div class="d-flex align-items-center justify-content-between">
                                               <p style="text-decoration: underline;">Orden de Fuerza</p>
                                                <button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#Modal1">Ascender Jugador</button>
                                            </div>
                                        </tbody>
                                    </table>
                                            ...
                                            foreach ($datas as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> class="resultado-select1" data-id="<?php echo $data->id; ?>">
                                                            <option value=""></option>
                                                            <option value="1" <?php if ($data->resultado == '1') echo 'selected'; ?>>1</option>
                                                            <option value="1/2" <?php if ($data->resultado == '1/2') echo 'selected'; ?>>1/2</option>
                                                            <option value="0" <?php if ($data->resultado == '0') echo 'selected'; ?>>0</option>
                                                    ...
                                                    <td><button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> class="delete-btn1 btn btn-danger me-2" data-id="<?php echo $data->id; ?>">Limpiar</button></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
                                    ...
                                    <div style="font-size: 9px;" class="modal-body bg-light p-2 rounded">
                                        <div class="row mb-3">
                                            <form id="firmaForm1" enctype="multipart/form-data" method="post">
                                               ...
                                               <!--  <div class="d-flex align-items-center">
                                                    <label for="firma" class="form-label text-primary fw-bold me-2">Firma del equipo Local</label> -->
                                                    <input readonly style="font-size: 9px;" value="<?= $firmab;?>" type="hidden" name="firma" class="form-control w-auto">
                                                <!-- </div> -->
                                                <div class="col-md-12 mb-3">
                                                    <label for="firma" class="form-label text-primary fw-bold me-2">Acta</label>
                                                    <div style="display: flex; align-items: center;">
                                                ...
                                                <div class="modal-footer bg-info d-flex justify-content-between pb-0 border-top mt-3">
                                                    ...
                                                    <button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> type="button" class="btn btn-primary submit-firma-form1">Enviar</button>
                                                </div>
                                            </form>
<script>
$(document).ready(function() {
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> type="button" class="btn btn-light me-2 submit-player-form1"><?php echo $data4->apellido1 . ' ' . $data4->apellido2 . ', ' . $data4->nombre; ?></button>
                                                        </form>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="player-form">
                                                            ...
                                                            <button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> type="button" class="btn btn-light me-2 submit-player-form1">Incomparecencia</button>
                                                        </form>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                            <div class="d-flex align-items-center justify-content-between">
                                               <p style="text-decoration: underline;">Orden de Fuerza</p>
                                                <button <?php if ($identificador==0) {
                                                   echo " disabled ";
                                                } ?> class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#Modal2">Ascender Jugador</button>
                                            </div>
                                        </tbody>
                                    </table>
                                    <p><i>Pinche sobre el jugador que desea incluir en el acta.</i></p>
                            ...
                            <div <?php if ($firma_ar!="") { ?> id="modal-body2" <?php }  ?> class="modal-body bg-light p-3 rounded">
                                <div class="row mb-3">
                                    ...
                                    <!-- <div class="d-flex align-items-center">
                                        ...
                                        <input type="hidden" value="<?= $firma_ar;?>" name="firma_arbitro" class="form-control w-auto">
                                    <!-- </div> -->
                                    <div class="modal-footer bg-info d-flex justify-content-between pb-0 border-top mt-3">
                                        <input type="hidden" name="id" value="<?php echo $competiciones->id; ?>">
