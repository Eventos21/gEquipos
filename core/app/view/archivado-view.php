                            ...
                            <table id="customerTable" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                <thead>
                                    <tr class="table-primary">
                                        ...
                                        <th width="10px"><i class="ri-briefcase-fill"></i></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <!-- Datos del club -->
        ...
        <div class="modal-body bg-light">
            <div class="row">
                ...
                <div class="col-md-4"> 
                    ...
                    <input class="form-control" name="limite" id="limite" type="date" aria-label="First name">
                </div>
                <div class="col-md-4">
      ...
      <form enctype="multipart/form-data" method="POST" class="tablelist-form" autocomplete="off" action="index.php?action=registro">
        <div class="modal-body bg-light">
            <div class="row">
                ...
                <div class="col-md-4"> 
                    <label class="form-label" for="first-name"> Limite de entregas</label>
                    <input class="form-control" name="limite" type="date" aria-label="First name">
                </div>
            </div>
        </div>
          <div class="modal-footer bg-info d-flex justify-content-between pb-0">
...
<script>
    $(document).ready(function() {
        $('#customerTable').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "index.php?action=apiarchivado",
            "columns": [
                { "data": function(row) {
                        return row.nombre ;
                    }
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        if (row.estado==1) {
                                   return '<a href="index.php?action=archivado&tid=' + row.id + '&tid2=3" title="Archivar" class="btn btn-info btn-sm archive-btn"><i class="ri-briefcase-fill"></i></a>';
                        } else {
                             return '<a href="index.php?action=archivado&tid=' + row.id + '&tid2=2" title="Mostrar el archivado" class="btn btn-warning btn-sm archive-btn"><i class="ri-eye-off-line"></i></a>';
                        }
