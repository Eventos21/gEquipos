            ...
            "columns": [
                ...
                { 
                    ...
                    "render": function(data, type, row) {
                        return '<button class="btn btn-primary btn-sm tabla-btn" data-id="' + row.id + '">Tabla</button>';
                    }
                }
            ],
            "language": {
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body bg-light">
                <div class="row">
                    <table id="tablaCompeticion" class="table table-bordered table-hover table-striped align-middle" style="width:100%">
                        <thead>
                            <tr>
                                <th>Ronda</th>
                                <th>Encuentro 1</th>
...
<div class="modal fade" id="tablacompeticionDHModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body bg-light">
                <div class="row">
                    <table id="tablaCompeticionDH" class="table table-bordered table-hover table-striped align-middle" style="width:100%">
                        <thead>
                            <tr>
                                <th>Ronda</th>
                                <th>Encuentro 1</th>
