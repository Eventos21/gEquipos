...
$vala = 0;
$valb = 0;
if ($u->club==$aquipoa->club) {
    $vala = 1;
}
if ($u->club==$aquipob->club) {
    $valb = 1;
}
    ...
    <div class="col-md-12 mb-3">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <?php if ($competiciones->archivoa!="") {
                echo "<a download='download' href='storage/archivo/$competiciones->archivoa'  style='font-size: 9px;'>Descargar</a>";
            } ?>
        </div>
    </div>
    ...
    <div class="col-md-12 mb-3">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <?php if ($competiciones->archivob!="") {
                echo "<a download='download' href='storage/archivo/$competiciones->archivob'  style='font-size: 9px;'>Descargar</a>";
            } ?>
        </div>
    </div>
    <div class="modal-footer bg-info d-flex justify-content-between pb-0 border-top mt-3">
